...
class UzairHaider:
    def __init__(self):
        ...
        self.university  = "NUML — BS Computer Science (2025–2029)"
        self.focus       = ["Artificial Intelligence", "Machine Learning", "Automation"]
        self.languages   = ["C", "C++", "Java (OOP)", "Python"]
        self.passion     = "Building scalable, data-driven solutions with AI"
        self.currently   = "Exploring AI tools & emerging technologies"
        self.fun_fact    = "I write code that thinks — and sometimes it surprises me 🤯"

    def say_hi(self):
        print("Hey! Thanks for stopping by. Let's build something amazing together.")
...
![Data Driven](https://img.shields.io/badge/Data--Driven%20Solutions-0ea5e9?style=for-the-badge&logo=databricks&logoColor=white)
...
<div align="center">
  <img src="https://github-profile-trophy.vercel.app/?username=uzairhaider381&theme=radical&no-frame=true&row=1&column=7&margin-w=10" width="100%" />
</div>
...
| 🎓 Certificate | 🏢 Issuer |
|:---|:---|
| Introduction to Machine Learning Concepts | Google |
| Introduction to AI Concepts | Google |
| Google AI for K–12 Educators | Google |
